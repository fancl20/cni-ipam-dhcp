...
func AcquireLease(clientID, netns, ifName, hostname string) (*DHCPLease, error) {
...
func (l *DHCPLease) acquire() error {
	c, err := newDHCPClient(l.link, l.clientID, l.hostname)
	if err != nil {
		return err
	}
	defer c.Close()
...
func newDHCPClient(link netlink.Link, clientID, hostname string) (*dhcp4client.Client, error) {
